...
# Addresses
payment_wallet_name="reference-wallet"
payment_address=$(cat ./wallets/${payment_wallet_name}/payment.addr)
script_reference_output_address=$(cat ./wallets/reference-wallet/payment.addr)
# use this for launches
# script_reference_output_address=$(jq -r '.script_reference_address' ../config.json)
