...
echo -e "\033[1;36m\nBuilding Babel Fees Contract \033[0m"
aiken blueprint convert -m babel_fees > contracts/babel_fees_contract.plutus
cardano-cli conway transaction policyid --script-file contracts/babel_fees_contract.plutus > hashes/babel_fees.hash
echo -e "\033[1;37m Babel Fee Contract Hash: $(cat hashes/babel_fees.hash) \033[0m"
...
echo -e "\033[1;37m Always False Contract Hash: $(cat hashes/always_false.hash)\033[0m"
